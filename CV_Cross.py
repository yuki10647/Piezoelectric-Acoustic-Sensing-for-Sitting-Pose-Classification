...
df1 = pd.read_csv('csv/data/TrainSet1.csv',header=None)
df2 = pd.read_csv('csv/data/TrainSet2.csv',header=None)
df3 = pd.read_csv('csv/data/TrainSet3.csv',header=None)
df4 = pd.read_csv('csv/data/TrainSet4.csv',header=None)
df5 = pd.read_csv('csv/data/TrainSet5.csv',header=None)
df6 = pd.read_csv('csv/data/TrainSet6.csv',header=None)
df7 = pd.read_csv('csv/data/TrainSet7.csv',header=None)
df8 = pd.read_csv('csv/data/TrainSet8.csv',header=None)
df9 = pd.read_csv('csv/data/TrainSet9.csv',header=None)
df10 = pd.read_csv('csv/data/TrainSet10.csv',header=None)
df11 = pd.read_csv('csv/data/TrainSet11.csv',header=None)


df1_swp = pd.read_csv('csv/data_swp/TrainSet1_swp.csv',header=None) # ChannelSwap利用
df2_swp = pd.read_csv('csv/data_swp/TrainSet2_swp.csv',header=None) # ChannelSwap利用
df3_swp = pd.read_csv('csv/data_swp/TrainSet3_swp.csv',header=None) # ChannelSwap利用
df4_swp = pd.read_csv('csv/data_swp/TrainSet4_swp.csv',header=None) # ChannelSwap利用
df5_swp = pd.read_csv('csv/data_swp/TrainSet5_swp.csv',header=None) # ChannelSwap利用
df6_swp = pd.read_csv('csv/data_swp/TrainSet6_swp.csv',header=None) # ChannelSwap利用
df7_swp = pd.read_csv('csv/data_swp/TrainSet7_swp.csv',header=None) # ChannelSwap利用
df8_swp = pd.read_csv('csv/data_swp/TrainSet8_swp.csv',header=None) # ChannelSwap利用
df9_swp = pd.read_csv('csv/data_swp/TrainSet9_swp.csv',header=None) # ChannelSwap利用
df10_swp = pd.read_csv('csv/data_swp/TrainSet10_swp.csv',header=None) # ChannelSwap利用
df11_swp = pd.read_csv('csv/data_swp/TrainSet11_swp.csv',header=None) # ChannelSwap利用


df_all = pd.concat([df1,df2,df3,df4,df5,df6,df7,df8,df9,df10,df11], axis=0)
df_all_swp = pd.concat([df1_swp,df2_swp,df3_swp,df4_swp,df5_swp,df6_swp,df7_swp,df8_swp,df9_swp,df10_swp,df11_swp,], axis=0)
...
for train_index, test_index in skf.split(df_all, labels):
    ...
    for epoch in tqdm(range(EPOCH),desc="User"):
        ...
        for data1, data2 in zip(trainloader1, trainloader2):
            ...
            CELoss = loss1 + loss2
            SCELoss = mse_loss(outputs_sub1, outputs_sub2)
            loss = 0.5*CELoss + 0.5*SCELoss
